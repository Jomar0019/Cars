      ...
      <div className="max-w-[1400px] mx-auto flex flex-col justify-center h-screen">
        ...
        <div className='w-full flex'>
            <div className="basis-1/2 p-4">
                <h4 className='text-3xl font-bold mb-3'>Our branch office</h4>
                <p className='w-3/4'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolor, quia perferendis? Dignissimos</p>
                <ul className='my-12'>
                    ...
                    <li className='flex gap-4 justify-start items-center my-12'>
            ...
            <div className="basis-1/2  p-4">
                <h4 className='text-3xl font-bold mb-3'>Our branch office</h4>
                <p className='w-3/4 mb-6'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolor, quia perferendis? Dignissimos</p>
                <input type="text" className='w-3/4 border px-3 py-2 rounded border-[#c1c1c1]' placeholder='Name'/>
                <input type="text" className='w-3/4 border px-3 py-2 rounded border-[#c1c1c1] my-2' placeholder='example@gmail.com'/>
                <div className='flex w-3/4 mb-2 gap-2'>
                ...
                <textarea name="" id="" cols="20" rows="6" className='block w-3/4 mb-2 border border-[#c1c1c1]  rounded px-3 py-2' placeholder='Your Message...'></textarea>
