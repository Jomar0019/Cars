    ...
    <div className='w-full h-screen bg-white p-4'>
        <div className="relative max-w-[1400px] mx-auto flex justify-center items-center gap-5 h-full">
          <div className='absolute bottom-0 md:relative basis-1/2'>
            <img src={Cars} alt="" className='md:max-w-[750px] object-contain'/>
          </div>
          <div className='w-full md:basis-1/2'>
            <h4 className='font-bold text-2xl text-red-500 border-b-2 border-b-red-500 inline'>About Us</h4>
            <h2 className='text-4xl md:text-6xl font-bold mt-6'>Biggest Car Dealer </h2>
            <h2 className='text-4xl md:text-6xl font-bold my-3 md:my-6'>Marketplace</h2>
            ...
            <ul className='my-6'>
              <li className='flex gap-3 items-center'>
                ...
                <p>Lorem ipsum dolor sit amet consec adipisi elit ab.</p>
              </li>
