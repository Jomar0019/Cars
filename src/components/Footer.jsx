...
const Footer = () => {
  return (
    <div className='w-full relative md:px-12 pb-6 bg-[#1c1d1e] text-white '>
      <div className="pt-56 grid grid-cols-1 md:grid-cols-4">
        <div className='p-4 text-center'>
          <h5 className='text-2xl font-bold mb-3 '>Cars</h5>
          <p className='text-sm md:text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore laboriosam minus quasi dicta aliquam consectetur modi facilis id, recusandae beatae velit quas voluptatum fugit.</p>
        </div>
        <div className='p-4 text-center md:text-start'>
          <h5 className='text-xl font-bold mb-3'>Categories</h5>
          <ul className='md:list-disc list-inside text-sm md:text-base'>
        ...
        <div className='p-4 text-center md:text-start'>
          ...
          <ul className='md:list-disc list-inside mb-3 text-sm md:text-base'>
